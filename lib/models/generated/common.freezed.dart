...
mixin _$TrackerInfo {
 ...
 String get id; int get upload; int get download; DateTime get start; Metadata get metadata; List<String> get chains; String get rule; String get rulePayload; ProtocolObservation? get observation; int? get downloadSpeed; int? get uploadSpeed;
...
int get hashCode {
  final _this = this as TrackerInfo;
  return Object.hash(runtimeType,_this.id,_this.upload,_this.download,_this.start,_this.metadata,const DeepCollectionEquality().hash(_this.chains),_this.rule,_this.rulePayload,_this.observation,_this.downloadSpeed,_this.uploadSpeed);
}

@override
String toString() {
  final _this = this as TrackerInfo;
  return 'TrackerInfo(id: ${_this.id}, upload: ${_this.upload}, download: ${_this.download}, start: ${_this.start}, metadata: ${_this.metadata}, chains: ${_this.chains}, rule: ${_this.rule}, rulePayload: ${_this.rulePayload}, observation: ${_this.observation}, downloadSpeed: ${_this.downloadSpeed}, uploadSpeed: ${_this.uploadSpeed})';
}
...
@useResult
$Res call({
 String id, int upload, int download, DateTime start, Metadata metadata, List<String> chains, String rule, String rulePayload, ProtocolObservation? observation, int? downloadSpeed, int? uploadSpeed
});
...
/// Create a copy of TrackerInfo
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? upload = null,Object? download = null,Object? start = null,Object? metadata = null,Object? chains = null,Object? rule = null,Object? rulePayload = null,Object? observation = freezed,Object? downloadSpeed = freezed,Object? uploadSpeed = freezed,}) {
...
as ProtocolObservation?,downloadSpeed: freezed == downloadSpeed ? _self.downloadSpeed : downloadSpeed // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  int upload,  int download,  DateTime start,  Metadata metadata,  List<String> chains,  String rule,  String rulePayload,  ProtocolObservation? observation,  int? downloadSpeed,  int? uploadSpeed)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TrackerInfo() when $default != null:
return $default(_that.id,_that.upload,_that.download,_that.start,_that.metadata,_that.chains,_that.rule,_that.rulePayload,_that.observation,_that.downloadSpeed,_that.uploadSpeed);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  int upload,  int download,  DateTime start,  Metadata metadata,  List<String> chains,  String rule,  String rulePayload,  ProtocolObservation? observation,  int? downloadSpeed,  int? uploadSpeed)  $default,) {final _that = this;
switch (_that) {
case _TrackerInfo():
return $default(_that.id,_that.upload,_that.download,_that.start,_that.metadata,_that.chains,_that.rule,_that.rulePayload,_that.observation,_that.downloadSpeed,_that.uploadSpeed);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  int upload,  int download,  DateTime start,  Metadata metadata,  List<String> chains,  String rule,  String rulePayload,  ProtocolObservation? observation,  int? downloadSpeed,  int? uploadSpeed)?  $default,) {final _that = this;
switch (_that) {
case _TrackerInfo() when $default != null:
return $default(_that.id,_that.upload,_that.download,_that.start,_that.metadata,_that.chains,_that.rule,_that.rulePayload,_that.observation,_that.downloadSpeed,_that.uploadSpeed);case _:
  return null;
...
class _TrackerInfo implements TrackerInfo {
  const _TrackerInfo({required this.id, this.upload = 0, this.download = 0, required this.start, required this.metadata, required  List<String> chains, required this.rule, required this.rulePayload, this.observation, this.downloadSpeed, this.uploadSpeed}): _chains = chains;
...
@override final  ProtocolObservation? observation;
...
@override
int get hashCode {
    return Object.hash(runtimeType,id,upload,download,start,metadata,const DeepCollectionEquality().hash(_chains),rule,rulePayload,observation,downloadSpeed,uploadSpeed);
}

@override
String toString() {
    return 'TrackerInfo(id: $id, upload: $upload, download: $download, start: $start, metadata: $metadata, chains: $chains, rule: $rule, rulePayload: $rulePayload, observation: $observation, downloadSpeed: $downloadSpeed, uploadSpeed: $uploadSpeed)';
}
...
/// Create a copy of TrackerInfo
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? upload = null,Object? download = null,Object? start = null,Object? metadata = null,Object? chains = null,Object? rule = null,Object? rulePayload = null,Object? observation = freezed,Object? downloadSpeed = freezed,Object? uploadSpeed = freezed,}) {
